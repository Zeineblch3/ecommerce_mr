...
export default function LoginPage() {
  ...
  async function handleCredentialsLogin(e) {
    ...
    try {
      // Appeler signIn de NextAuth avec le provider "credentials"
      ...
      if (result?.error) {
        ...
        // Connexion reussie : redirection vers l'accueil
        router.push("/admin");
        router.refresh(); // Rafraichir pour mettre a jour la session
      }
    } catch (err) {
